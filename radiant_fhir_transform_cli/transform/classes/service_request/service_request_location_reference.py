...
class ServiceRequestLocationReferenceTransformer(FhirResourceTransformer):
    ...
    Attributes:
        ...
        subtype (str): Specifies the sub-element of the resource to focus on ('locationReference').
    ...
    Methods:
        __init__():
            ...
            subtype 'locationReference', and the specified transformation dictionary.
    """
