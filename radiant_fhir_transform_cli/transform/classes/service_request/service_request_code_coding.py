"""
FHIR ServiceRequest Code Coding transformer
"""
...
class ServiceRequestCodeCodingTransformer(FhirResourceTransformer):
    """
    Transformer class for the 'ServiceRequest' resource in FHIR, focusing on the 'code.coding' element.
    ...
    def __init__(self):
        super().__init__("ServiceRequest", "code_coding", TRANSFORM_SCHEMA)
