"""
FHIR Location Identifier transformer
"""
...
class LocationIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Location' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the LocationIdentifierTransformer instance with the resource type 'Location',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Location", "identifier", TRANSFORM_SCHEMA)
