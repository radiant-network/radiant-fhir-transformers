"""
FHIR Goal Identifier transformer
"""
...
class GoalIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Goal' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the GoalIdentifierTransformer instance with the resource type 'Goal',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Goal", "identifier", TRANSFORM_SCHEMA)
