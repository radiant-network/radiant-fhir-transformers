"""
FHIR DiagnosticReport Category transformer
"""
...
class DiagnosticReportCategoryTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'DiagnosticReport' resource in FHIR, focusing on the 'category' element.
    ...
    def __init__(self):
        super().__init__("DiagnosticReport", "category", TRANSFORM_SCHEMA)
