"""
FHIR DiagnosticReport basedOn transformer
"""
...
class DiagnosticReportBasedOnTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'DiagnosticReport' resource in FHIR, focusing on the 'basedOn' element.
    ...
    def __init__(self):
        super().__init__("DiagnosticReport", "based_on", TRANSFORM_SCHEMA)
