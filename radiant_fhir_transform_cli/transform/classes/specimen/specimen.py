...
TRANSFORM_SCHEMA = [
    ...
    },
    {
        ...
        "columns": {
            ...
            "accession_identifier_system": {"fhir_key": "system", "type": "str"},
            "accession_identifier_value": {"fhir_key": "value", "type": "str"},
            "accession_identifier_period": {"fhir_key": "period", "type": "str"},
            "accession_identifier_assigner_reference": {"fhir_key": "assigner.reference", "type": "str"},
            "accession_identifier_assigner_display": {"fhir_key": "assigner.display", "type": "str"},
            },
    },
    {
        "fhir_path": "status",
    ...
    },
    {
        ...
        "columns": {
            ...
            "collection_collector_display": {"fhir_key": "display", "type": "str"},
        },
    },
    {
    ...
    },
    {
        ...
        "columns": {
            "collection_collected_period_start": {"fhir_key": "start","type": "datetime"},
            "collection_collected_period_end": {"fhir_key": "end","type": "datetime"},            
         },
    },
    {
        "fhir_path": "collection.collectedDuration",
        "columns": {
            "collection_collected_duration_value": {"fhir_key": "value","type": "str"},
            "collection_collected_duration_comparator": {"fhir_key": "comparator","type": "str"},
            "collection_collected_duration_unit": {"fhir_key": "unit","type": "str"},
            "collection_collected_duration_system": {"fhir_key": "system","type": "str"},   
            "collection_collected_duration_code": {"fhir_key": "code","type": "str"},                       
         },
    },
    {
        "fhir_path": "collection.collectedQuantity",
        "columns": {
            "collection_collected_quantity_value": {"fhir_key": "value","type": "str"},
            "collection_collected_quantity_unit": {"fhir_key": "unit","type": "str"},
            "collection_collected_quantity_system": {"fhir_key": "system","type": "str"},   
            "collection_collected_quantity_code": {"fhir_key": "code","type": "str"},                       
         },
    },
    {
    ...
    },    
    {
        ...
        "columns": {
            "collected_fasting_status_duration_value": {"fhir_key": "value","type": "str"},
            "collected_fasting_status_duration_comparator": {"fhir_key": "comparator","type": "str"},
            "collected_fasting_status_duration_unit": {"fhir_key": "unit","type": "str"},
            "collected_fasting_status_duration_system": {"fhir_key": "system","type": "str"},   
            "collected_fasting_status_duration_code": {"fhir_key": "code","type": "str"},                       
         },
    },
    {
