...
TRANSFORM_SCHEMA = [
    ...
    },
    {
        ...
        "columns": {
            ...
            "container_capacity_value": {"fhir_key": "capacity.value","type": "str"},
            "container_capacity_unit": {"fhir_key": "capacity.unit","type": "str"},
            "container_capacity_system": {"fhir_key": "capacity.system","type": "str"},   
            "container_capacity_code": {"fhir_key": "capacity.code","type": "str"},   
            "specimen_quantity_value": {"fhir_key": "specimenQuantity.value","type": "str"},
            "specimen_quantity_unit": {"fhir_key": "specimenQuantity.unit","type": "str"},
            "specimen_quantity_system": {"fhir_key": "specimenQuantity.system","type": "str"},   
            "specimen_quantity_code": {"fhir_key": "specimenQuantity.code","type": "str"},  
            "specimen_additive_codeable_concept_text": {"fhir_key": "specimen.additiveCodeableConcept.text","type": "str"},
            "specimen_additive_codeable_concept_coding": {"fhir_key": "specimen.additiveCodeableConcept.coding","type": "str"},
            "specimen_additive_reference_reference": {"fhir_key": "specimen.additiveReference.reference","type": "str"},
            "specimen_additive_reference_display": {"fhir_key": "specimen.additiveReference.display","type": "str"},
        },
    },
]
