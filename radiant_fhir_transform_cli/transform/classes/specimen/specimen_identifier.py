...
class SpecimenIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Specimen' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the SpecimenCodeCodingTransformer instance with the resource type 'Specimen',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Specimen", "identifier", TRANSFORM_SCHEMA)
