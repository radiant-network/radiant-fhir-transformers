"""
FHIR AllergyIntolerance Note transformer
"""
...
class AllergyIntoleranceNoteTransformer(FhirResourceTransformer):
    """
    Transformer class for the 'AllergyIntolerance' resource in FHIR, focusing on the 'note' element.
    ...
    Methods:
        __init__():
            Initializes the AllergyIntoleranceNoteTransformer instance with the resource type 'AllergyIntolerance',
            subtype 'note', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("AllergyIntolerance", "note", TRANSFORM_SCHEMA)
