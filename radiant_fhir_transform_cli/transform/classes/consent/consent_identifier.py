"""
FHIR Consent Identifier transformer
"""
...
class ConsentIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Consent' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the ConsentIdentifierTransformer instance with the resource type 'Consent',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Consent", "identifier", TRANSFORM_SCHEMA)
