"""
FHIR MedicationDispense Type Coding transformer
"""
...
class MedicationDispenseTypeCodingTransformer(FhirResourceTransformer):
    ...
    Methods:
        __init__():
            Initializes the MedicationDispenseTypeCodingTransformer instance with the resource type 'MedicationDispense',
