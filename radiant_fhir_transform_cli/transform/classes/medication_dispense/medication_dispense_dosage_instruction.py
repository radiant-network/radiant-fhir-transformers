"""FHIR MedicationDispense dosage_instruction transformer"""
...
VIEW_DEFINITION = {
    ...
    "name": "medication_dispense_dosage_instruction",
    "status": "active",
    "constant": [
        {
            "name": "id_hash",
...
class MedicationDispenseDosageInstructionTransformer(FhirResourceTransformer):
    def __init__(self):
        super().__init__("MedicationDispense", "dosage_instruction", VIEW_DEFINITION)
