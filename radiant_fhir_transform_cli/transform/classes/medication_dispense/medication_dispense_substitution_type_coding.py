"""
FHIR MedicationDispense Substitution Type Coding transformer
"""
...
TRANSFORM_SCHEMA = [
    ...
    {
        "fhir_path": "substitution.type.coding",
        "columns": {
            "substitution_type_coding_system": {
                "fhir_key": "system",
                "type": "str",
            },
...
class MedicationDispenseSubstitutionTypeCodingTransformer(FhirResourceTransformer):
    ...
    Attributes:
        ...
        subtype (str): Specifies the sub-element of the resource to focus on ('substitution_type_coding').
        transform_dict (dict): A dictionary defining the mapping and transformation rules for the resource data.

    Methods:
        __init__():
            Initializes the MedicationDispenseSubstitutionTypeCodingTransformer instance with the resource type 'MedicationDispense',
            subtype 'substitution_type_coding', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__(
            "MedicationDispense", "substitution_type_coding", TRANSFORM_SCHEMA
        )
