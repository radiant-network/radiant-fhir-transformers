"""
FHIR List Code Coding transformer
"""
...
class ListCodeCodingTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'List' resource in FHIR, focusing on the 'code.coding' element.
    ...
    Methods:
        __init__():
            Initializes the ListCodeCodingTransformer instance with the resource type 'List',
            subtype 'code_coding', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("List", "code_coding", TRANSFORM_SCHEMA)
