"""
FHIR Procedure Identifier transformer
"""
...
class ProcedureIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Procedure' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the ProcedureIdentifierTransformer instance with the resource type 'Procedure',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Procedure", "identifier", TRANSFORM_SCHEMA)
