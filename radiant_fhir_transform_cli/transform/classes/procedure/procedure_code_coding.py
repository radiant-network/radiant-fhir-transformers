"""
FHIR Procedure Code Coding transformer
"""
...
class ProcedureCodeCodingTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Procedure' resource in FHIR, focusing on the 'code.coding' element.
    ...
    Methods:
        __init__():
            Initializes the ProcedureCodeCodingTransformer instance with the resource type 'Procedure',
            subtype 'code_coding', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Procedure", "code_coding", TRANSFORM_SCHEMA)
