"""
FHIR Procedure Note transformer
"""
...
class ProcedureNoteTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Procedure' resource in FHIR, focusing on the 'note' element.
    ...
    Methods:
        __init__():
            Initializes the ProcedureNoteTransformer instance with the resource type 'Procedure',
            subtype 'note', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Procedure", "note", TRANSFORM_SCHEMA)
