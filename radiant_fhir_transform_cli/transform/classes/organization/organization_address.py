...
class OrganizationAddressTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Organization' resource in FHIR, focusing on the 'address' element.
    ...
    Methods:
        __init__():
            Initializes the OrganizationAddressTransformer instance with the resource type 'Organization',
            subtype 'address', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Organization", "address", TRANSFORM_SCHEMA)
