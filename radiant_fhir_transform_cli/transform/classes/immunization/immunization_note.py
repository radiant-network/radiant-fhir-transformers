"""
FHIR Immunization Note transformer
"""
...
class ImmunizationNoteTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Immunization' resource in FHIR, focusing on the 'note' element.
    ...
    Methods:
        __init__():
            Initializes the ImmunizationNoteTransformer instance with the resource type 'Immunization',
            subtype 'note', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Immunization", "note", TRANSFORM_SCHEMA)
