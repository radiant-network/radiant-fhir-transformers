"""
FHIR Immunization Identifier transformer
"""
...
class ImmunizationIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Immunization' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the ImmunizationIdentifierTransformer instance with the resource type 'Immunization',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Immunization", "identifier", TRANSFORM_SCHEMA)
