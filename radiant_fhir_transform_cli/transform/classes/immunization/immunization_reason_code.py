"""
FHIR Immunization ReasonCode transformer
"""
...
class ImmunizationReasonCodeTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Immunization' resource in FHIR, focusing on the 'reasonCode' element.
    ...
    Methods:
        __init__():
            Initializes the ImmunizationReasonCodeTransformer instance with the resource type 'Immunization',
            subtype 'reason_code', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Immunization", "reason_code", TRANSFORM_SCHEMA)
