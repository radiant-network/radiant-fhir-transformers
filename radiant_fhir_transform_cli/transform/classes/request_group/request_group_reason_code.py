"""
FHIR RequestGroup ReasonCode transformer
"""
...
class RequestGroupReasonCodeTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'RequestGroup' resource in FHIR, focusing on the 'reasonCode' element.
    ...
    Methods:
        __init__():
            Initializes the RequestGroupReasonCodeTransformer instance with the resource type 'RequestGroup',
            subtype 'reason_code', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("RequestGroup", "reason_code", TRANSFORM_SCHEMA)
