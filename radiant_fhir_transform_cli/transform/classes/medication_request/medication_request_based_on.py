"""
FHIR MedicationRequest BasedOn transformer
"""
...
class MedicationRequestBasedOnTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'MedicationRequest' resource in FHIR, focusing on the 'basedOn' element.
    ...
    def __init__(self):
        super().__init__("MedicationRequest", "based_on", TRANSFORM_SCHEMA)
