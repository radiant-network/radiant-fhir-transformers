"""
FHIR MedicationRequest DosageInstruction transformer
"""
...
class MedicationRequestDosageInstructionTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'MedicationRequest' resource in FHIR, focusing on the 'dosageInstruction' element.
    ...
    Methods:
        __init__():
            Initializes the MedicationRequestDosageInstructionTransformer instance with the resource type 'MedicationRequest',
            subtype 'dosage_instruction', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__(
            "MedicationRequest", "dosage_instruction", TRANSFORM_SCHEMA
        )
