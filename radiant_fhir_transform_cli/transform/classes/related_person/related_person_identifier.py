"""
FHIR RelatedPerson Identifier transformer
"""
...
class RelatedPersonIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'RelatedPerson' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the RelatedPersonIdentifierTransformer instance with the resource type 'RelatedPerson',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("RelatedPerson", "identifier", TRANSFORM_SCHEMA)
