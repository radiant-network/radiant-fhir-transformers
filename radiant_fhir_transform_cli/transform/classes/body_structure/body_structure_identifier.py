"""
FHIR BodyStructure Identifier transformer
"""
...
class BodyStructureIdentifierTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'BodyStructure' resource in FHIR, focusing on the 'identifier' element.
    ...
    Methods:
        __init__():
            Initializes the BodyStructureIdentifierTransformer instance with the resource type 'BodyStructure',
            subtype 'identifier', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("BodyStructure", "identifier", TRANSFORM_SCHEMA)
