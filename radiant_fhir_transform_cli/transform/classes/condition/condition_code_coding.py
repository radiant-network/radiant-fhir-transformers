"""
FHIR Condition Code Coding transformer
"""
...
class ConditionCodeCodingTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Condition' resource in FHIR, focusing on the 'code.coding' element.
    ...
    Methods:
        __init__():
            Initializes the ConditionCodeCodingTransformer instance with the resource type 'Condition',
            subtype 'code_coding', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Condition", "code_coding", TRANSFORM_SCHEMA)
