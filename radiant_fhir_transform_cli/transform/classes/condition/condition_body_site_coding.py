"""
FHIR Condition Body Site Coding transformer
"""
...
class ConditionBodySiteCodingTransformer(FhirResourceTransformer):
    """
    A transformer class for the 'Condition' resource in FHIR, focusing on the 'body_site.coding' element.

    This class transforms FHIR Condition JSON objects into flat dictionaries suitable for CSV output,
    extracting and processing information from the 'body_site.coding' field.
    ...
    Methods:
        __init__():
            Initializes the ConditionBodySiteCodingTransformer instance with the resource type 'Condition',
            subtype 'body_site_coding', and the specified transformation dictionary.
    """

    def __init__(self):
        super().__init__("Condition", "body_site_coding", TRANSFORM_SCHEMA)
