"""
Test helper class for FHIR resource type MedicationDispense subtype Substitution Type Coding
"""
...
EXPECTED_OUTPUT = [
    {
        ...
        "substitution_type_coding_display": "Inpatient",
    }
]


class MedicationDispenseSubstitutionTypeCodingTestHelper(FhirResourceTestHelper):
    """
    ...
    resource_component = "substitution_type_coding"
    transformer = MedicationDispenseSubstitutionTypeCodingTransformer
    expected_table_name = "medication_dispense_substitution_type_coding"
