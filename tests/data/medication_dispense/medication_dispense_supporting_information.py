"""
Test helper class for FHIR resource type MedicationDispense supportingInformation
"""
...
EXPECTED_OUTPUT = [
    {
        ...
        "supporting_information_reference": "Condition/f203",
...
class MedicationDispenseSupportingInformationTestHelper(FhirResourceTestHelper):
    """
    ...
    resource_component = "supporting_information"
    transformer = MedicationDispenseSupportingInformationTransformer
    expected_table_name = "medication_dispense_supporting_information"
