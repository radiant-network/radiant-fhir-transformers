"""
Test helper class for FHIR resource type MedicationDispense subtype Category Coding
"""
...
EXPECTED_OUTPUT = [
    {
        ...
        "category_coding_system": "http://terminology.hl7.org/CodeSystem/medicationdispense-category",
        "category_coding_code": "inpatient",
        "category_coding_display": "Inpatient",
    }
]


class MedicationDispenseCategoryCodingTestHelper(FhirResourceTestHelper):
    """
