"""
Test helper class for FHIR resource type MedicationDispense receiver
"""
...
EXPECTED_OUTPUT = [
    {
        ...
        "receiver_reference": "Patient/pat1",
        "receiver_type": None,
        "receiver_display": "Donald Duck",
    }
]
    
class MedicationDispenseReceiverTestHelper(FhirResourceTestHelper):
    """
