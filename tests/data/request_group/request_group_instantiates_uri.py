"""
Test helper class for FHIR resource type RequestGroup subtype InstantiatesUri
"""
...
EXPECTED_OUTPUT = [
    {
        "instantiates_uri": "PlanDefinition/KDN5",
        "id": "fb24ccde-1a4a-49d2-bbf2-0069b603d6db",
        "request_group_id": "kdn5-example",
    },
]


class RequestGroupInstantiatesUriTestHelper(FhirResourceTestHelper):
    """
