"""
Test helper class for FHIR resource type Immunization subtype Reaction
"""
...
class ImmunizationReactionTestHelper(FhirResourceTestHelper):
    """
    ...
    transformer = ImmunizationReactionTransformer
    expected_table_name = "immunization_reaction"
