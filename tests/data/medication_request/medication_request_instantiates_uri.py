"""
Test helper class for FHIR resource type MedicationRequest subtype InstantiatesUri
"""
...
EXPECTED_OUTPUT = [
    {
        ...
        "instantiates_uri_value": "uri",
    }
]


class MedicationRequestInstantiatesUriTestHelper(FhirResourceTestHelper):
    """
