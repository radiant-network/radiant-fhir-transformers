"""
Test helper class for FHIR resource type Observation subtype EffectiveTiming Event
"""
...
class ObservationEffectiveTimingEventTestHelper(FhirResourceTestHelper):
    """
