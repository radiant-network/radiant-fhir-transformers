"""
Test helper class for FHIR resource type Observation subtype DerivedFrom
"""
...
EXPECTED_OUTPUT = [
    {
        "derived_from_reference": "DocumentReference/document-reference",
        "derived_from_type": None,
        "derived_from_display": None,
        "id": "6e8e0d07-f4cf-4456-9b54-a29a03d5c3c2",
        "observation_id": "fUru66DnsInJJFSK0eHsjU8K8GtyH6pkh0LeyaSldORw4",
    },
]


class ObservationDerivedFromTestHelper(FhirResourceTestHelper):
    """
