"""
Test helper class for FHIR resource type Observation subtype EffectiveTiming Repeat TimeOfDay
"""
...
EXPECTED_OUTPUT = [
    {
        "effective_timing_repeat_time_of_day": "16:46:00",
        "id": "e4aeaa92-4e27-4010-a83e-d38ba5872271",
...
class ObservationEffectiveTimingRepeatTimeOfDayTestHelper(
    ...
    resource_component = "effective_timing_repeat_time_of_day"
    transformer = ObservationEffectiveTimingRepeatTimeOfDayTransformer
    expected_table_name = "observation_effective_timing_repeat_time_of_day"
