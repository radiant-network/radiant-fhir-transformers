"""
Test helper class for FHIR resource type ServiceRequest subtype specimen
"""
...
class ServiceRequestSpecimenTestHelper(FhirResourceTestHelper):
    """
    ...
    transformer = ServiceRequestSpecimenTransformer
    expected_table_name = "service_request_specimen"
