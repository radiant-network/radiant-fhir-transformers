"""
Test helper class for FHIR resource type ServiceRequest subtype instantiatesUri
"""
...
EXPECTED_OUTPUT = [
    {
        "instantiates_uri": "myurivalue.com",
...
class ServiceRequestInstantiatesUriTestHelper(FhirResourceTestHelper):
    """
